...
(function() {
  ...
  Migration = (function() {
    ...
    function Migration(file, options) {
      var dir;
    ...
    Migration.prototype.up = function(db) {
      ...
      m = require(this.path);
      if (m.up != null) {
        if (!((_ref = this.options) != null ? _ref.quiet : void 0)) {
          console.log("up " + this.filename);
        }
  ...
  module.exports = Migrate = (function() {
      ...
      return this.sort((function() {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          ...
          _results.push(new Migration(path.join(this.path, f), {
            quiet: (_ref1 = this.options) != null ? _ref1.quiet : void 0
          }));
        }
        return _results;
      }).call(this));
    ...
    Migrate.prototype.unfinished = function() {
      ...
      return this.available().filter(function(a) {
        return !finished.some(function(f) {
